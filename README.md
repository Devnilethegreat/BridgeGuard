# BridgeGuard: Cross-chain bridge security monitor and anomaly alert system Implementation
> Advanced javascript solution leveraging modern architecture patterns and cutting-edge AI technology.

BridgeGuard watches bridge contract balances, validator signatures, and relayer liveness across Wormhole, LayerZero, and Across, triggering AI-scored security alerts when invariants are violated.

BridgeGuard's key benefits include:
...
```bash
git clone https://github.com/Devnilethegreat/BridgeGuard.git
cd BridgeGuard
```
...
- **2024-11-26** — Expand test coverage for edge cases
- **2025-01-19** — Expand test coverage for edge cases
